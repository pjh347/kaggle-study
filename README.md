...
BusTracker o-- BusInfo : tracks
BusTracker --> BusArrivalPredictor : uses
...
FastAPIServer ..> BusLocationData : request
...
MultiStopETACalculator --> BusArrivalPredictor : segment ETA
...
BusDataCollector ..> FastAPIServer : POST batch
...
TrainPipeline ..> BusArrivalPredictor : trains/saves
